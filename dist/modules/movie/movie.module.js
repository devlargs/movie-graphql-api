...
MovieModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: movie_model_1.Movie.name, schema: movie_model_1.MovieSchema }]),
        ],
        providers: [movie_service_1.MovieService, movie_resolver_1.MovieResolver],
    })
], MovieModule);
