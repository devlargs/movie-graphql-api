    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                { name: director_model_1.Director.name, schema: director_model_1.DirectorSchema },
            ]),
        ],
        providers: [director_service_1.DirectorService, director_resolver_1.DirectorResolver],
    })
], DirectorModule);
